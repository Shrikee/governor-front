...
export interface ProposalGovernorInterface extends utils.Interface {
  functions: {
...
export interface ProposalGovernor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProposalGovernorInterface;
